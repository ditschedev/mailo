...
final class MjmlMailBuilder implements TemplateMailBuilder {
    ...
    private String renderMustacheTemplate(String templatePath) {
        ...
        String templateFile = MailBuilder.class.getResource(templatePath) == null ? null : MailBuilder.class.getResource(templatePath).getFile();
    ...
    public Mail build() {
        ...
        mail.setBody(mjmlClient.render(body));
